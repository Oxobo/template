...
public class JmsConfig {
    ...
    public Queue receiveQueue() {
        return new Queue(env.getProperty("tue.receiver.queue"), true);
    }
    @Bean(name = "sendQueue")
    public Queue sendQueue() {
        return new Queue(env.getProperty("tue.sender.queue"), true);
    }
...
/*    @Bean
    ...
    public MQQueueConnectionFactory mqQueueConnectionFactory() {
        ...
        try {
            factory.setHostName(env.getProperty("tue.mq.host"));
            factory.setTransportType(WMQConstants.WMQ_CM_CLIENT);
            factory.setChannel(env.getProperty("tue.mq.channel"));
            factory.setPort(Integer.parseInt(env.getProperty("tue.mq.port")));
            factory.setQueueManager(env.getProperty("tue.mq.queue-manager"));
