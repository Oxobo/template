...
package ir.itsurena.base.core.config.apidoc;


import ir.itsurena.base.core.config.JHipsterProperties;
import ir.itsurena.base.core.config.apidoc.customizer.JHipsterSwaggerCustomizer;
import ir.itsurena.base.core.config.apidoc.customizer.SwaggerCustomizer;
...
import static ir.itsurena.base.core.config.Constants.SPRING_PROFILE_SWAGGER;
 ...
 * In that case, you can use the "no-itsurena" Spring profile, so that this bean is ignored.
 */
@Configuration
