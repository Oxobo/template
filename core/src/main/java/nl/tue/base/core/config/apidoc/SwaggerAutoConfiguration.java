...
import nl.tue.base.core.config.apidoc.customizer.JHipsterSwaggerCustomizer;
import nl.tue.base.core.config.apidoc.customizer.SwaggerCustomizer;
...
import static nl.tue.base.core.config.Constants.SPRING_PROFILE_SWAGGER;
 ...
 * In that case, you can use the "no-tue" Spring profile, so that this bean is ignored.
 */
@Configuration
